export const PRICING_TABLE = [
  ...
  { provider: "OpenAI", name: "GPT-5.4 Fast", input: 5, cacheWrite: null, cacheRead: 0.5, output: 30, isAuto: false, pool: "api", aliases: ["gpt-5.4-fast", "gpt-5-4-fast"] },
  ...
  { provider: "OpenAI", name: "GPT-5.5 Fast", input: 10, cacheWrite: null, cacheRead: 1, output: 60, isAuto: false, pool: "api", aliases: ["gpt-5.5-fast", "gpt-5-5-fast"] },
  { provider: "OpenAI", name: "GPT-5.6 Luna", input: 1, cacheWrite: 1.25, cacheRead: 0.1, output: 6, isAuto: false, pool: "api", aliases: ["gpt-5.6-luna", "gpt-5-6-luna"] },
  { provider: "OpenAI", name: "GPT-5.6 Luna Fast", input: 2, cacheWrite: 2.5, cacheRead: 0.2, output: 12, isAuto: false, pool: "api", aliases: ["gpt-5.6-luna-fast", "gpt-5-6-luna-fast"] },
  ...
  { provider: "OpenAI", name: "GPT-5.6 Terra", input: 2.5, cacheWrite: 3.125, cacheRead: 0.25, output: 15, isAuto: false, pool: "api", aliases: ["gpt-5.6-terra", "gpt-5-6-terra"] },
  { provider: "OpenAI", name: "GPT-5.6 Terra Fast", input: 5, cacheWrite: 6.25, cacheRead: 0.5, output: 30, isAuto: false, pool: "api", aliases: ["gpt-5.6-terra-fast", "gpt-5-6-terra-fast"] },
